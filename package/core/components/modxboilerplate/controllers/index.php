 ...
 */
require_once dirname(dirname(__FILE__)).'/model/modxboilerplate/modxboilerplate.class.php';
$modxboilerplate = new modxboilerplate($modx);
return $modxboilerplate->initialize('mgr');