 ...
 */
$alreadyExists = $modx->getObject('modxboilerplateItem',array(
    'name' => $_POST['name'],
));
if ($alreadyExists) {
    $modx->error->addField('name',$modx->lexicon('modxboilerplate.item_err_ae'));
}
...
$item = $modx->newObject('modxboilerplateItem');
